...
@echo .
@IF "x%1"=="x" ECHO Please call this script with a team number and
@IF "x%1"=="x" ECHO device type; using using %UNKNOWN_TEAM% for now.
@echo .
...
@IF "x%1"=="x" SET TEAM=%UNKNOWN_TEAM%
